...
import traceabilityRoutes from "./routes/traceability.routes.js";import marketInsightsRoutes from './routes/market-insights.routes.js';
...
app.use("/api/traceability", traceabilityRoutes);app.use('/api/market-insights', marketInsightsRoutes);
// 404 Handler
app.use((req, res) => {
  res.status(404).json({
...
app.listen(PORT, () => {
  ...
  console.log("  GET  /api/traceability/:batchId");  console.log('  GET  /api/market-insights');
  console.log('  GET  /api/market-insights/trending');
  console.log('  GET  /api/market-insights/top-trades');
  console.log('  GET  /api/market-insights/price-analysis');  console.log("═══════════════════════════════════════════════════════");
});
